    ...
    <div class="card modal-content rounded-3 border-light shadow-lg overflow-hidden">
      ...
      <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom">
        <h5 class="modal-title fw-bold" id="detalleVentaModalLabel">
         Comprobante de Venta <span id="modal-nro-venta" class="text-muted">#00000</span>
        </h5>
      ...
      <div class="modal-body p-4">
        <div class="row g-3 mb-4 bg-light p-3 rounded-3 border border-light">
          <div class="col-sm-6 col-md-3">
            <span class="text-secondary small d-block">Cliente:</span>
            <strong id="modal-cliente" class="text-dark"></strong>
          </div>
          <div class="col-sm-6 col-md-3">
            <span class="text-secondary small d-block">Forma de Pago:</span>
            <strong id="modal-forma-pago" class="text-dark"></strong>
          </div>
          <div class="col-sm-6 col-md-3">
            <span class="text-secondary small d-block">Registrado por:</span>
            <strong id="modal-operador" class="text-dark"></strong>
          </div>
          <div class="col-sm-6 col-md-3 text-sm-end text-md-end">
            <span class="text-secondary small d-block">Fecha y Hora:</span>
            <strong id="modal-fecha" class="text-dark"></strong>
          </div>
        </div>
          ...
          <table class="table table-bordered align-middle mb-0">
            ...
            <tfoot>
              <tr class="table-light-subtle border-bottom-0">
                ...
                <td id="modal-descuento-venta" class="text-end fw-bold text-danger small py-2">$</td>
              </tr>
              <tr class="table-light">
                <td colspan="3" class="text-end fw-bold text-dark py-2">Monto Total:</td>
                <td id="modal-total-venta" class="text-end fw-bold text-success fs-5 py-2"></td>
              </tr>
            </tfoot>
          </table>
        </div>
      ...
      <div class="card-footer bg-light d-flex justify-content-between align-items-center py-3 border-top">
        ...
        <div class="justify-end">
          <button type="button" class="btn btn-danger btn-sm px-4 btnBorrarVenta">
            <i class="bi bi-trash-fill me-1"></i>Borrar
          </button>
          <button type="button" class="btn btn-outline-danger btn-sm px-4 btnImprimirTicketModal">
